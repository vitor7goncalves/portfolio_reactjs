...
export const SidebarPageTwo = () => {

    const urlHome = localStorage.getItem('urlHome');
    let lang = "";

    const handleChangeLanguage = (language) => {
        if (language === "/jogosdigitais") {
            lang = "/pt-br";
                ...
                <div className="top-bar">
                    <div className="top-bar-soon">
                        ...
                        <div className='select'>
                            <button onClick={() => handleChangeLanguage('/jogosdigitais')}><img src={br} /></button>
                            <button onClick={() => handleChangeLanguage('/digitalgames')}><img src={eua} /></button>
                        </div>
                    </div>
                </div>
            </div>
