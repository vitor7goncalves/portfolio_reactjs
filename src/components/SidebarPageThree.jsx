...
export const SidebarPageThree = () => {

    const urlHome = localStorage.getItem('urlHome');
    let lang = "";

    const handleChangeLanguage = (language) => {
        if (language === "/meusprojetos") {
            lang = "/pt-br";
                ...
                <div className="top-bar">
                    <div className="top-bar-soon">
                        ...
                        <div className='select'>
                            <button onClick={() => handleChangeLanguage('/meusprojetos')}><img src={br} /></button>
                            <button onClick={() => handleChangeLanguage('/myprojects')}><img src={eua} /></button>
                        </div>
                    </div>
                </div>
            </div>
